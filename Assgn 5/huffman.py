...
# For HTML file:
process_file('html', 'sample1.html')
process_file('html', 'sample2.html')

# For DOCX file:
process_file('docx', 'sample1.docx')
process_file('docx', 'sample2.docx')

# For PDF file:
process_file('pdf', 'sample1.pdf')
process_file('pdf', 'sample2.pdf')

# For TXT file:
process_file('txt', 'sample1.txt')
process_file('txt', 'sample2.txt')
